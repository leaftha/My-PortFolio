  ...
  const projects: project[] = [
...

    {
      ...
      description: {
        ...
        solution:
          "책 독후감을 작성하고 저장하는 기능은 상대적으로 쉽게 개발되었습니다. 사용자가 책의 제목과 저자 정보를 입력한 후, MarkDown을 사용해 독후감을 작성하고 저장하면 MongoDB에 데이터가 저장됩니다. 하지만 사용자 간의 의견을 나눌 수 있는 토론 기능을 개발하는 데 어려움을 겪었습니다. 처음에는 실시간 웹소켓을 이용해 채팅방 형식을 고려하거나 나무위키의 토론 기능을 참고하려 했으나, Vercel에서 웹소켓 사용이 어렵다는 정보를 확인하고 대체 방안을 모색했습니다. Firebase를 통해 실시간 채팅을 구현할 수 있었지만, 당시에는 이 아이디어를 떠올리지 못해, 최종적으로는 댓글과 대댓글 기능을 구현해 사용자들이 의견을 나눌 수 있도록 했습니다.",
        feedback:
